...
<template>
  <header class="flex items-center justify-end px-6 py-2 bg-white border-b-4 border-b-primary">
    <div class="flex items-center">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input
          ...
          placeholder="Search"
        /> -->
        <!-- <h1 class="text-xs mt-2 text-gray-600">{{ new Date() }}</h1> -->
    ...
    <div class="flex items-center">
      <div class="flex items-center">
        <div class="relative">
          ...
          >
            ...
            <a
              href="#"
              class="flex items-center px-4 py-3 text-gray-600 hover:text-white hover:bg-primary -mx-2"
            >
              <img
                class="h-8 w-8 rounded-full object-cover mx-1"
      ...
      <div class="relative">
        <button
          ...
          class="relative z-10 block border-2 border-typography w-8 h-8 overflow-hidden rounded-full shadow focus:outline-none"
        >
          <img
            class="object-cover bg-primary w-full h-full"
            :src="user.__store__.logoUrl"
            alt="Your avatar"
          />
        </button>
        ...
        >
          ...
          >
            <a
              href="/editprofile"
              class="px-4 py-2 flex rounded-md text-sm text-gray-700 hover:bg-primary hover:text-white"
            >
              <svg
            ...
            <a
              href="#"
              class="flex rounded-md px-4 py-2 text-sm text-gray-700 hover:bg-primary hover:text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-1"
            ...
            <router-link
              to="/"
              class="flex px-4 py-2 rounded-md text-sm text-gray-700 hover:bg-primary hover:text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-1"
